      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            />
            <p className="text-rundag-blue-foreground/80 leading-relaxed mb-8">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  <a 
                    ...
                    className="w-10 h-10 bg-rundag-red text-white rounded-full flex items-center justify-center hover:bg-rundag-red/80 transition-colors"
                  >
          ...
          {/* Right side - Google Map taking 2/3 of the width */}
